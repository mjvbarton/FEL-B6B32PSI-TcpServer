...
public class RequestSyntaxErrorTest {
    
    @Mock
    private Session session;
    
    public RequestSyntaxErrorTest() {
    }
    ...
    public void testToString() {
        String expected = "501 SYNTAX ERROR \r\n";
        Response instance1 = new RequestSyntaxError(session);
        RequestSyntaxError instance2 = new RequestSyntaxError(session);
